...
static const yytype_int16 yyrline[] =
{
     ...
     198,   204,   208,   212,   216,   226,   228,   236,   238,   240,
     242,   247,   249,   256,   263,   264,   266,   271,   273,   279,
     281,   283,   285,   287,   289,   291,   293,   300,   302,   304,
     309,   313,   321,   324,   328,   331,   337,   340,   346,   348,
     350,   352,   357,   359,   361,   363,   365,   372,   374,   380,
     385,   392,   395,   402,   405,   412,   415,   423,   426,   432,
     434,   440,   447,   449,   451,   453,   455,   457,   459,   464,
     466,   471,   473,   478,   480,   482,   484,   486,   491,   493,
     495,   497,   499,   504,   506,   511,   513,   518,   520,   522,
     527,   529,   531,   536,   538,   540,   542,   547,   549,   554,
     556,   558,   560,   562,   564,   569,   571,   573,   575,   577,
     579,   581,   583,   588,   591,   595,   597,   603,   610,   613,
     615,   617,   619,   624,   625,   626,   627,   628,   629,   630,
     634,   637,   643,   645
};
#endif
...
#line 131 "k0gram.y"
        { (yyval.treeptr) = (yyvsp[0].treeptr); }
#line 1528 "k0gram.tab.c"
    break;

  case 14: /* declaration: property_declaration  */
#line 133 "k0gram.y"
        { (yyval.treeptr) = (yyvsp[0].treeptr); }
#line 1534 "k0gram.tab.c"
    break;
...
#line 144 "k0gram.y"
        { (yyval.treeptr) = alloktree(R_OPTIONAL_RETURN_TYPE, "optional_return_type", 2,
                         (yyvsp[-1].treeptr), (yyvsp[0].treeptr)); }
#line 1548 "k0gram.tab.c"
    break;

  case 17: /* optional_return_type: %empty  */
#line 147 "k0gram.y"
        { (yyval.treeptr) = NULL; }
#line 1554 "k0gram.tab.c"
    break;
...
#line 2180 "k0gram.tab.c"
    break;

  case 117: /* range_expr: additive_expr  */
#line 519 "k0gram.y"
        { (yyval.treeptr) = (yyvsp[0].treeptr); }
#line 2186 "k0gram.tab.c"
    break;
...
#line 2300 "k0gram.tab.c"
    break;

  case 137: /* postfix_expr: postfix_expr DECR  */
#line 574 "k0gram.y"
        { (yyval.treeptr) = alloktree(R_POSTFIX_EXPR, "postfix_expr", 2, (yyvsp[-1].treeptr),  (yyvsp[0].treeptr)); }
#line 2306 "k0gram.tab.c"
    break;
